  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      ...
      <div className="flex border-b">
        <button
          className={`px-4 py-2 font-medium ${activeTab === 'upcoming' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500'}`}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant={appointment.type === 'teleconsult' ? 'secondary' : 'default'}>
                          {appointment.type}
                        </Badge>
                      </div>
                    </div>
